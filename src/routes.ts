...
import { reportModule } from './application/report/modules/ReportModule';
...
import { ReportRoutes } from './application/report/routes/ReportRoutes';
...
export class Routes {
  ...
  private build() {
    ...
    this.addRoutes(new ReportRoutes('/report', reportModule.controller))
  }
